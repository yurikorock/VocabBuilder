...
export const selectWordsTotalPage = (state: RootState) =>
  state.words.totalPages;

export const selectWordsStatistics = (state: RootState) =>
  state.words.totalCount;

export const selectModalWordId = (state: RootState) => state.modal.wordId;

export const selectWordById = (id: string) => (state: RootState) =>
  state.words.words.find((word) => word._id === id);
